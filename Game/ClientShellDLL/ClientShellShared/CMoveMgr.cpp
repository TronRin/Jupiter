...
#define DEFAULT_WORLD_GRAVITY			-1300.0f
...
LTBOOL CMoveMgr::Init()
{
	m_CV_SpectatorSpeedMul.Init(g_pLTClient, "SpectatorSpeedMul", NULL, 1.0f);
 	...
 	g_vtFallDamageMinHeight.Init(g_pLTClient, "FallDamageMinHeight", LTNULL, 400.0f);
    g_vtFallDamageMaxHeight.Init(g_pLTClient, "FallDamageMaxHeight", LTNULL, 600.0f);
